...
func Oeffnen (dateiname string, modus byte) *data {
	var d = new(data)
	var err error
	...
	switch modus {
		...
		case 'a':
		((*d).f), err= os.OpenFile(dateiname,os.O_WRONLY | os.O_APPEND,io.SeekStart)
		default:
